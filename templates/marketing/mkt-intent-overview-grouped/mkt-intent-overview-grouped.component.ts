...
@Component({
  selector: 'mvp-mkt-intent-overview-grouped',
  templateUrl: './mkt-intent-overview-grouped.component.html',
  styleUrls: ['./mkt-intent-overview-grouped.component.scss'],
  providers: [Marketing, Template],
})
export class MktIntentOverviewGroupedComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  reportInfo = {group: 'Marketing', name: 'Marketing Intent Overview Grouped Report'};
  sortDisable = false;
  sort2Disable = false;
  sort3Disable = false;
  sort4Disable = false;
